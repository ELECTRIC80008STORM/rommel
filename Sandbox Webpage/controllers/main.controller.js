exports.get_root = (request, response, next) => {
    response.render('article', {
        ...
        includeContent: true,
        content: `
        <a href="https://docs.google.com/document/d/1201l2ge3rhdCpdNmBi7jHMV8zsxhtWfLNue8585kfr8/edit#heading=h.iwrd8gb25vbc">Link To Document with the Question's Answer</a>
        `,
    });
};